...
typedef OnClickListener = void Function(String tag);

class FloatButtonOverlay {
  static const MethodChannel _channel =
      const MethodChannel('br.com.scrumlab.scrumlab_float_button_overlay');
  ...
  static Future<String> closeOverlay() async {
