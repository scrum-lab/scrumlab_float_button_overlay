package br.com.scrumlab.scrumlab_float_button_overlay.utils;

public class Constants {

    public static final String PACKAGE = "br.com.scrumlab.scrumlab_float_button_overlay";
    public static final String CHANNEL = PACKAGE;
    public static final String TAG = "ScrumlabFloatButtonPlugin";
